...
namespace Crypto\CryptoPayment\Helper;

use Magento\Framework\App\Config\ScopeConfigInterface;

class ConfigReader
{
    public const PAYMENT_CODE = 'crypto_payment';

    private const CONFIG_ETHER_PAYMENT_ACTIVE = 'payment/crypto_payment/active';
    private const CONFIG_ETHER_PAYMENT_TITLE = 'payment/crypto_payment/title';
    private const CONFIG_ETHER_PAYMENT_NETWORK_VERSION = 'payment/crypto_payment/network_version';
    private const CONFIG_ETHER_PAYMENT_MERCHANT_ADDRESS = 'payment/crypto_payment/merchant_ether_address';

    private const CONFIG_ETHER_PAYMENT_ETHERSCAN_URL = 'payment/crypto_payment/etherscan_url';
    private const CONFIG_ETHER_PAYMENT_ETHERSCAN_CHECK_ON = 'payment/crypto_payment/etherscan_check';
    private const CONFIG_ETHER_PAYMENT_ETHERSCAN_API_URL = 'payment/crypto_payment/etherscan_api_url';
    private const CONFIG_ETHER_PAYMENT_ETHERSCAN_API_KEY = 'payment/crypto_payment/etherscan_api_key';

    private const CONFIG_TEST_ETHER_PAYMENT_ACTIVE = 'payment/crypto_payment/test_mode/active';
    private const CONFIG_TEST_ETHER_PAYMENT_NETWORK_VERSION = 'payment/crypto_payment/test_mode/network_version';
    private const CONFIG_TEST_ETHER_PAYMENT_MERCHANT_ADDRESS = 'payment/crypto_payment/test_mode/merchant_ether_address';

    private const CONFIG_TEST_ETHER_PAYMENT_ETHERSCAN_URL = 'payment/crypto_payment/test_mode/etherscan_url';
    private const CONFIG_TEST_ETHER_PAYMENT_ETHERSCAN_CHECK_ON = 'payment/crypto_payment/test_mode/etherscan_check';
    private const CONFIG_TEST_ETHER_PAYMENT_ETHERSCAN_API_URL = 'payment/crypto_payment/test_mode/etherscan_api_url';
    private const CONFIG_TEST_ETHER_PAYMENT_ETHERSCAN_API_KEY = 'payment/crypto_payment/test_mode/etherscan_api_key';
